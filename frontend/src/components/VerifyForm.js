...
import { verifyDelivery } from '../utils/api';
...
const VerifyForm = () => {
    ...
    return (
        <div className="max-w-md mx-auto mt-10 bg-white p-8 border border-gray-200 rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold mb-6 text-gray-900">Verify Organ Delivery</h2>
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                    <label htmlFor="transportID" className="block text-sm font-medium text-gray-700">
                        Transport ID
                    </label>
                    <input
                        type="text"
